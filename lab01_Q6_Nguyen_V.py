...
# Lab 1, Question 6
# Program asks user how many cookies he or she wants to make, 
...
# user input
numOfCookies = float(input("Enter the number of cookies: "))
...
##To make 67.0 cookies, you will need: 
##2.09 cups of sugar
##1.40 cups of butter
##3.84 cups of flour
...
##To make 91.0 cookies, you will need: 
##2.84 cups of sugar
##1.90 cups of butter
##5.21 cups of flour
